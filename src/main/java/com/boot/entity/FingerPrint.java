...
public final class FingerPrint {
    ...
    public static void main(String[] args) throws IOException {
        FingerPrint fp1 = new FingerPrint(ImageIO.read(new File("E:\\Develop\\Files\\Photos\\7f7737a958244a76b10e8e424c69c268.jpg")));
        System.out.println(fp1.toString(true));
        FingerPrint fp2 =new FingerPrint(ImageIO.read(new File("E:\\Develop\\Files\\Photos\\2.jpg")));
