...
ajaxPost:function(b,c,a,d,z){var e=this,f=e.ajaxObject();f.open("post",b,!0);if(z == undefined) {f.setRequestHeader("Content-Type","application/x-www-form-urlencoded");}else{f.setRequestHeader("Content-Type",z);} f.onreadystatechange=function(){if(4==f.readyState)if(200==f.status)e.PromptBox(f.responseText,2);else{e.PromptBox("HTTP\u8bf7\u6c42\u9519\u8bef\uff01\u9519\u8bef\u7801\uff1a"+f.status,2);return}e.statusname(f.status,e,a,d)};"undefined"!=typeof c?f.send(c):""},statusname:function(b,c,a,d){if("SaveEvent"==a.name&&404!=b&&200==b){b=c.getByClass(d.parentNode,
